...
**In:** spec lifecycle (claim, approve, close, park, reopen, block, unblock, ratify, handoff, task ops, lint, init, doctor), profile system (`default → bastion`), `spec_lint` strict-mode validation.
