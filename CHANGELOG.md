...
- Refreshed all dependencies (`bun audit` clean) and raised `spec_lint` test coverage across error paths, multi-root resolution, and strict-format branches. No tool-surface or behavioural changes.
